  ...
  return BottomNavigationBar(
    ...
    onTap: (index) {
      if (index == 0) {
        ...
        if (ModalRoute.of(context)?.settings.arguments is! ChatRoute) {
          Navigator.push(context, MaterialPageRoute(builder: (context) => const ChatRoute()));
        }
      }
    },
  );
            ...
            children: <Widget>[
              ...
              Container(
                child: Card(
                    ...
                    color: isMe ? Color(0xff5EA1D5) : Colors.grey,
                    elevation: 0,
                    child: Padding(
