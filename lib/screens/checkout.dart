        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(20*fem, 25*fem, 24.5*fem, 18*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    // titleQv4 (102:4206)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 152.5*fem, 0*fem),
                    child: Text(
                      'Payment method',
                      style: safeGoogleFont (
                        'SF Pro Text',
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(21*fem, 15*fem, 223*fem, 15*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(20*fem, 0*fem, 24.5*fem, 18*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(23*fem, 16*fem, 182*fem, 16*fem),
              width: double.infinity,
              child: Row(
