                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 15*fem, 0*fem, 5*fem),
                            child: Text(
                              'Kibirige Martin\n',
                              style: safeGoogleFont (
                                'SF Pro Text',
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 52.5*fem, 15*fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 128*fem,
                    decoration: BoxDecoration (
                      borderRadius: BorderRadius.circular(6.2169289589*fem),
                      color: const Color(0xffdbd8dd),
                      image: const DecorationImage (
                        image: AssetImage (
                          '',
