        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 13*fem, 20*fem, 65*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(13*fem, 13*fem, 16.65*fem, 13*fem),
                          width: double.infinity,
                          height: 48*fem,
                          decoration: BoxDecoration (
                            border: Border.all(color: const Color(0xffd8d0e3)),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 164*ffem, 0*fem),
                                width: 147*fem,
                                height: double.infinity,
                                child: Center(
                                  child: Text(
